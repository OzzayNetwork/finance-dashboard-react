...
const Students=()=>{
    ...
    const[blinkUserType,setBlinkUserType]=useState("Student")
    ...
    const profileNameFormatter=(cell,row)=>{
     ...
     const validationStatus=(cell,row)=>{
        if(cell==="Pending"){
            return(
                <>
                  <span class="badge badge-soft-warning text-uppercase fw-medium">Pending</span>                 
                </>
            )
        }
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 className="mb-sm-0 font-size-18">All blinlkers</h4>
